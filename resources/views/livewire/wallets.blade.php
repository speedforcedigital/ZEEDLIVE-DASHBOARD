                            ...
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                <div class="space-x-1">
                                     <button class="text-slate-400 hover:text-slate-500 rounded-full"
                                      ...
                                      <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-circle-plus" width="27" height="27" viewBox="0 0 24 24" stroke-width="1.5" stroke="#2c3e50" fill="none" stroke-linecap="round" stroke-linejoin="round">
              ...
              <div class="flex items-center justify-center min-h-screen px-4">
                  ...
                  <div class="bg-white rounded-xl max-w-xl w-full overflow-hidden shadow-2xl transform transition-all">
                      ...
                      <div class="p-5">
                        ...
                        <input type="number" id="wallet_balance" name="wallet_balance" wire:model="wallet_balance"
                    ...
                    <button wire:click="addBalance" class="px-5 py-2 text-gray-100 bg-green-600 hover:bg-green-700 transition duration-150 rounded">Add Balance</button>
                    <button wire:click="$set('showModal', false)" class="ml-2 px-5 py-2 text-gray-100 bg-red-600 hover:bg-red-700 transition duration-150 rounded">Close</button>
                </div>
                  </div>
              </div>
          </div>
