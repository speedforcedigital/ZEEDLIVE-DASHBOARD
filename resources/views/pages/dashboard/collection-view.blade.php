                ...
                <div class="swiper-container product-slider">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="{{  $collection->image }}" alt="Product Image" class="w-3/4 h-56  rounded-lg shadow-lg">
                        </div>
...
{{--                    <div class="swiper-button-prev"></div>--}}
                ...
                <div class="mt-4">
                    ...
                    <div class="relative">
                        <video id="collectionVideo" controls width="100%" height="auto" class="rounded-lg shadow-lg">
            ...
            <div class="w-full md:w-1/2 px-4 mb-4">
                ...
                <div class="mb-4">
                    <div class="flex items-center">
                        <img src="{{ $collection->user->accountDetail->profile_image }}" alt="Seller Avatar" class="w-12 h-12 rounded-full">
                        <div class="ml-4">
