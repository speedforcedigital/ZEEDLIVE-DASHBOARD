                            ...
                            <li class="sm:flex sm:items-center sm:justify-between">
                                ...
                                <div class="sm:ml-2 mt-2 sm:mt-0">
                                    <ul class="flex flex-wrap sm:justify-end -m-1">
                                        <li class="m-1">
                                            <button class="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-slate-200 hover:border-slate-300 shadow-sm bg-white text-slate-500 duration-150 ease-in-out">{{$order->total_amount}} SAR</button>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                    ...
                    <ul class="space-y-5 my-6">
                        ...
                        <li>
                            <div class="flex items-center mb-2">
                                <img class="w-8 h-8 rounded-full mr-3" src="{{$rating->user->accountDetail->profile_image ?? Null}}"
                                     width="32" height="32" alt="User 07"/>
                                <div>
                                    <div class="text-sm font-semibold text-slate-800 mb-1">{{$rating->user->name}}</div>
                                    <!-- Rating -->
                                    <div class="flex items-center space-x-2">
                                        <!-- Stars -->
                                        <div class="flex space-x-1">
