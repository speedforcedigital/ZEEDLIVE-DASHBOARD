          ...
          <div>
            ...
            <div>
              ...
              <div class="flex">
                ...
                <svg class="w-4 h-4 fill-current opacity-75" viewBox="0 0 20 20">
                    <path
                        fill-rule="evenodd"
                        d="M14.95 5.365A7.001 7.001 0 007.54 19.56a6.97 6.97 0 01-3.266-.82l-1.505.755a8.001 8.001 0 009.95-12.455l.003.004-.003-.004zm.662-4.177L15 5a1 1 0 01-2 0V2.001a8.001 8.001 0 00-12.455 9.95l.755 1.506A6.97 6.97 0 014.44 7.537 7.001 7.001 0 0018 7a1 1 0 01-2 0 5 5 0 10-7.66-4.154l-.073.072-1.477-1.476A7.963 7.963 0 0110 0c4.411 0 8 3.589 8 8a1 1 0 01-2 0 5.963 5.963 0 00-1.388-3.76z"
                        clip-rule="evenodd"
                    />
                    </svg>
                </button>
