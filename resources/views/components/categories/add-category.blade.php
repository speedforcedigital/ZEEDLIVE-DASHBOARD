              ...
              <div class="flex">
                ...
                <button class="btn bg-indigo-500 hover:bg-indigo-600 text-white ml-2" wire:click="resetSelection">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current opacity-50 shrink-0" viewBox="0 0 16 16">
                        <path d="M17.649 6.942c-.283-3.978-3.515-7.041-7.542-6.76C6.13.47 2.067 3.703 2.35 7.68c.093 1.308.568 2.595 1.402 3.69l-1.1 1.1c-.379.378-.378.993 0 1.372l4.1 4.1c.379.378.993.378 1.372 0l4.1-4.1c.379-.378.379-.993 0-1.372l-1.1-1.1c1.095-.835 2.383-1.31 3.69-1.402 3.977-.283 7.21 2.82 6.927 6.798-.06.833-.335 1.63-.792 2.335h2.703c.556 0 1.006-.45 1.006-1.006V7.948c0-.557-.45-1.007-1.006-1.007h-3.48l-2.827-2.827z"/>
                    </svg>
                </button>
              </div>
