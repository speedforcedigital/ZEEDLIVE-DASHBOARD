...
<div class="bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">All Offers <span class="text-slate-400 font-medium">{{$count}}</span>
        </h2>
    </header>
                    ...
                    <tr>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <div class="flex items-center">
                                ...
                                @if(isset($offer['collection']))
                                    <div class="font-medium text-slate-800"><a
                                            href="{{ route("collection.show",$offer['collection']['id'] ) }}">{{ $offer['collection']['title'] }}</a>
                                    </div>
                                @endif
                            </div>
                        </td>
                        ...
                        <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                            <button
                                class="inline-flex items-center justify-center text-sm font-medium leading-5 rounded-full px-3 py-1 border border-transparent shadow-sm bg-indigo-500 text-white duration-150 ease-in-out">{{ $offer['modrator_status'] }}</button>
                        </td>
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex justify-end">
                                                        ...
                                                        <template x-if="collectionsCount > 0">
                                                            <button
                                                                class="btn-sm bg-indigo-500 hover:bg-indigo-600 text-white"
                                                                @click="rejectModalOpen = false">OK
                                                            </button>
                                                        </template>
                                                    </div>
                                                </div>
