...
<div class="relative inline-flex" x-data="{ open: false }">
    <button
        ...
        :aria-expanded="open"
    >
        <img class="w-8 h-8 rounded-full" src="https://zeed-live.nyc3.cdn.digitaloceanspaces.com/{{Session::get('profile_image')}}" width="32" height="32" alt="{{Session::get('name')}}" />
    ...
    >
        <div class="pt-0.5 pb-2 px-3 mb-1 border-b border-slate-200">
            <div class="font-medium text-slate-800">{{Session::get('name')}}</div>
