                ...
                <tbody class="text-sm divide-y divide-slate-200">
                    ...
                    <?php $i++;?>
                        <tr>
                            ...
                            <div class="flex items-center">
                                    ...
                                    <div class="font-medium text-slate-800"><a href="{{ route('user.show',$seller['user']['id']) }}">{{ $seller['user']['name'] }}</a></div>
                                </div>
                            </td>
                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                    ...
                    <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                           {{-- @if($verification_capability_exists) --}}
                            <button wire:click="approved({{ $seller['id'] }})" class="btn border-slate-200 hover:border-slate-300">
                            ...
                            <button wire:click="rejected({{ $seller['id'] }})" class="btn border-slate-200 hover:border-slate-300">
