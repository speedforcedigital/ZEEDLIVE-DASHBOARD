...
<div class="bg-white shadow-lg rounded-sm border border-slate-200">
    <header class="px-5 py-4">
        <h2 class="font-semibold text-slate-800">All Notifications <span class="text-slate-400 font-medium">{{$count}}</span></h2>
    </header>
                    ...
                    <?php $i++;?>
                        <tr>
                            ...
                            <div class="flex items-center">
                                    <div class="font-medium text-slate-800">{{$val['title']}}</div>
                                </div>
                            </td>
                            ...
                            <button wire:click="delete({{$val['id']}})" class="btn border-slate-200 hover:border-slate-300">
